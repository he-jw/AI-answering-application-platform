...
import com.jingweihe.yudada.manager.AiManager;
import com.jingweihe.yudada.model.dto.question.*;
import com.jingweihe.yudada.model.entity.App;
import com.jingweihe.yudada.model.entity.Question;
import com.jingweihe.yudada.model.entity.User;
import com.jingweihe.yudada.model.enums.AppTypeEnum;
import com.jingweihe.yudada.model.vo.QuestionVO;
import com.jingweihe.yudada.service.AppService;
import com.jingweihe.yudada.service.QuestionService;
...
public class QuestionController {
    ...
    private static final String GENERATE_QUESTION_SYSTEM_MESSAGE = "你是一位严谨的出题专家，我会给你如下信息：\n" +
            ...
            "```\n" +
            "title 是题目，options 是选项，每个选项的 key 按照英文字母序（比如 A、B、C、D）以此类推，value 是选项的描述内容\n" +
            "3. 检查题目是否包含序号，若包含序号则去除序号\n" +
            "4. 检查题目是否包含key，若包含key则去除key\n" +
    ...
    public SseEmitter aiGenerateQuestionSSE(AiGenerateQuestionRequest aiGenerateQuestionRequest,
        ...
        modelDataFlowable
                ...
                .doOnError((e) -> log.info("sse error",e))
                .doOnComplete(() -> {
                    sseEmitter.complete();
                })
                .subscribe();
